...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    {Pyhton, Tensorflow, Scikit-Learn, Machine Learning}{\href{https://github.com/NalishJain/Optimizing-Campus-Dining}{Github}}
    \begin{itemize}
...
\vspace{-5pt}
    ...
    {Pyhton, PyTorch, Reinforcement Learning}{\href{https://github.com/raunak21484/RL-DQN-DormantNeurons}{Github}}
    \begin{itemize}
...
\vspace{-5pt}
    ...
    \begin{itemize}
    \item {Developed a fast moving GUI based clone of the game 'TankStars'  with customized tanks, weapons and live background in Java using principles of OOPs with the additional functionality of \textbf{saving games and loading saved games}.}
    \end{itemize}
